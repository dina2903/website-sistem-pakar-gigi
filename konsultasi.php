...
<p><span class="style1">Jawablah Pertanyaan Berikut Sesuai Dengan Gejala Penyakit Pada Gigi Anda !!!</span><?php echo "$_GET[hal]"; ?> <span class="style1">dari</span> <?php echo "$jml"; ?></p>
<br>
<?php
$posisi=$_GET['hal']-1;
